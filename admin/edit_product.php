...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_update_product = "UPDATE products SET ProductName = ?, Description = ?, Price = ?, StockQuantity = ?, CategoryID = ? WHERE ProductID = ?";
    $stmt_update_product = mysqli_prepare($conn, $sql_update_product);
    mysqli_stmt_bind_param($stmt_update_product, "ssdiii", $product_name, $description, $price, $stock_quantity, $category_id, $product_id);
